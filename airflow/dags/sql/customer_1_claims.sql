CREATE OR REPLACE TABLE raw_claims (
    ...
    claim_id STRING,
    near_line_record_code STRING,
    claim_type_code STRING,
    claim_start_date DATE,
    claim_end_date DATE,
    weekly_processing_date DATE,
    fiscal_processing_date DATE,
    claim_query_code STRING,
    provider_number STRING,
    facility_type_code STRING,
    service_classification_code STRING,
    claim_frequency_code STRING,
    fiscal_intermediary_number INT,
    medicare_non_payment_reason_code NUMERIC(18, 2),
    claim_payment_amount NUMERIC(18, 2),
    primary_payer_payment_amount NUMERIC(18, 2),
    primary_payer_code STRING,
    claim_action_code STRING,
    provider_state_code STRING,
    organization_npi_number INT,
    attending_physician_upin STRING,
    attending_physician_npi STRING,
    operating_physician_upin STRING,
    operating_physician_npi STRING,
    other_physician_upin STRING,
    other_physician_npi STRING,
    managed_care_plan_switch STRING,
    patient_discharge_status_code STRING,
    pps_indicator_code STRING,
    total_charge_amount NUMERIC(18, 2),
    admission_date DATE,
    admission_type_code STRING,
    admission_source_code STRING,
    patient_status_indicator STRING,
    pass_through_per_diem_amount NUMERIC(18, 2),
    inpatient_deductible_amount NUMERIC(18, 2),
    coinsurance_liability_amount NUMERIC(18, 2),
    blood_deductible_amount NUMERIC(18, 2),
    professional_component_charge_amount NUMERIC(18, 2),
    non_covered_charge_amount NUMERIC(18, 2),
    total_deduction_amount NUMERIC(18, 2),
    total_pps_capital_amount NUMERIC(18, 2),
    pps_capital_federal_specific_amount NUMERIC(18, 2),
    pps_capital_outlier_amount NUMERIC(18, 2),
    pps_capital_disproportionate_share_amount NUMERIC(18, 2),
    pps_capital_indirect_medical_education_amount NUMERIC(18, 2),
    pps_capital_exception_payment_amount NUMERIC(18, 2),
    pps_old_capital_hold_harmless_amount NUMERIC(18, 2),
    pps_drg_weight STRING,
    utilization_day_count INT,
    total_coinsurance_days_count INT,
    lifetime_reserve_days_used INT,
    non_utilization_days_count INT,
    blood_units_furnished_quantity STRING,
    uncovered_stay_start_date DATE,
    uncovered_stay_end_date DATE,
    covered_care_end_date DATE,
    benefits_exhaustion_date DATE,
    patient_discharge_date DATE,
    drg_code STRING,
    drg_outlier_stay_code STRING,
    approved_drg_outlier_payment_amount NUMERIC(18, 2),
    admitting_diagnosis_code STRING,
    principal_diagnosis_code STRING,
    icd_diagnosis_code1 STRING,
    poa_indicator1 STRING,
    icd_diagnosis_code2 STRING,
    poa_indicator2 STRING,
    icd_diagnosis_code3 STRING,
    poa_indicator3 STRING,
    icd_diagnosis_code4 STRING,
    poa_indicator4 STRING,
    icd_diagnosis_code5 STRING,
    poa_indicator5 STRING,
    icd_diagnosis_code6 STRING,
    poa_indicator6 STRING,
    icd_diagnosis_code7 STRING,
    poa_indicator7 STRING,
    icd_diagnosis_code8 STRING,
    poa_indicator8 STRING,
    icd_diagnosis_code9 STRING,
    poa_indicator9 STRING,
    icd_diagnosis_code10 STRING,
    poa_indicator10 STRING,
    icd_diagnosis_code11 STRING,
    poa_indicator11 STRING,
    icd_diagnosis_code12 STRING,
    poa_indicator12 STRING,
    icd_diagnosis_code13 STRING,
    poa_indicator13 STRING,
    icd_diagnosis_code14 STRING,
    poa_indicator14 STRING,
    icd_diagnosis_code15 STRING,
    poa_indicator15 STRING,
    icd_diagnosis_code16 STRING,
    poa_indicator16 STRING,
    icd_diagnosis_code17 STRING,
    poa_indicator17 STRING,
    icd_diagnosis_code18 STRING,
    poa_indicator18 STRING,
    icd_diagnosis_code19 STRING,
    poa_indicator19 STRING,
    icd_diagnosis_code20 STRING,
    poa_indicator20 STRING,
    icd_diagnosis_code21 STRING,
    poa_indicator21 STRING,
    icd_diagnosis_code22 STRING,
    poa_indicator22 STRING,
    icd_diagnosis_code23 STRING,
    poa_indicator23 STRING,
    icd_diagnosis_code24 STRING,
    poa_indicator24 STRING,
    icd_diagnosis_code25 STRING,
    poa_indicator25 STRING,
    first_external_diagnosis_code STRING,
    external_diagnosis_code1 STRING,
    external_poa_indicator1 STRING,
    external_diagnosis_code2 STRING,
    external_poa_indicator2 STRING,
    external_diagnosis_code3 STRING,
    external_poa_indicator3 STRING,
    external_diagnosis_code4 STRING,
    external_poa_indicator4 STRING,
    external_diagnosis_code5 STRING,
    external_poa_indicator5 STRING,
    external_diagnosis_code6 STRING,
    external_poa_indicator6 STRING,
    external_diagnosis_code7 STRING,
    external_poa_indicator7 STRING,
    external_diagnosis_code8 STRING,
    external_poa_indicator8 STRING,
    external_diagnosis_code9 STRING,
    external_poa_indicator9 STRING,
    external_diagnosis_code10 STRING,
    external_poa_indicator10 STRING,
    external_diagnosis_code11 STRING,
    external_poa_indicator11 STRING,
    external_diagnosis_code12 STRING,
    external_poa_indicator12 STRING,
    icd_procedure_code1 STRING,
    procedure_date1 DATE,
    icd_procedure_code2 STRING,
    procedure_date2 DATE,
    icd_procedure_code3 STRING,
    procedure_date3 DATE,
    icd_procedure_code4 STRING,
    procedure_date4 DATE,
    icd_procedure_code5 STRING,
    procedure_date5 DATE,
    icd_procedure_code6 STRING,
    procedure_date6 DATE,
    icd_procedure_code7 STRING,
    procedure_date7 DATE,
    icd_procedure_code8 STRING,
    procedure_date8 DATE,
    icd_procedure_code9 STRING,
    procedure_date9 DATE,
    icd_procedure_code10 STRING,
    procedure_date10 DATE,
    icd_procedure_code11 STRING,
    procedure_date11 DATE,
    icd_procedure_code12 STRING,
    procedure_date12 DATE,
    icd_procedure_code13 STRING,
    procedure_date13 DATE,
    icd_procedure_code14 STRING,
    procedure_date14 DATE,
    icd_procedure_code15 STRING,
    procedure_date15 DATE,
    icd_procedure_code16 STRING,
    procedure_date16 DATE,
    icd_procedure_code17 STRING,
    procedure_date17 DATE,
    icd_procedure_code18 STRING,
    procedure_date18 DATE,
    icd_procedure_code19 STRING,
    procedure_date19 DATE,
    icd_procedure_code20 STRING,
    procedure_date20 DATE,
    icd_procedure_code21 STRING,
    procedure_date21 DATE,
    icd_procedure_code22 STRING,
    procedure_date22 DATE,
    icd_procedure_code23 STRING,
    procedure_date23 DATE,
    icd_procedure_code24 STRING,
    procedure_date24 DATE,
    icd_procedure_code25 STRING,
    procedure_date25 DATE,
    uncompensated_care_payment_amount NUMERIC(18, 2),
    line_number INT,
    revenue_center_code STRING,
    hcpcs_code STRING,
    deductible_coinsurance_code STRING,
    source_file_name STRING,
    METADATA$FILENAME STRING,
    loaded_timestamp TIMESTAMP
);

COPY INTO CLAIMS_DATABASE.PUBLIC.raw_claims (
    beneficiary_id,
    claim_id,
...
FROM (
    SELECT
        ...
        CAST(NULLIF($15, ' ') AS NUMERIC(18, 2)) AS medicare_non_payment_reason_code,
...
ON_ERROR = 'CONTINUE'
PATTERN = '.*customer_1_inpatient_20200101.csv.gz';